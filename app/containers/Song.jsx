          ...
          {!this.props.hideActions && (
            <div className="d-flex">
              <ion-icon
                ...
                name={
                  currentPlaying.videoId === song.videoId &&
                  currentPlaying.playing
                    ? 'pause'
                    : 'play'
                }
              ...
              <ion-icon
                onClick={event => {
                  ...
                  if (this.props.fromPlaylist) {
                    return this.props.removeSongFromPlaylist(song.videoId);
                  }
                  this.addSongToPlaylist();
                }}
                name={this.props.fromPlaylist ? 'remove' : 'add'}
                style={iconStyles}
              />
            </div>
          )}
