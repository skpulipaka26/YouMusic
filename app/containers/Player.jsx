...
class Player extends Component {
  ...
  render() {
    ...
    return playlist
      .filter(
        song =>
          currentPlaying.videoId && song.videoId === currentPlaying.videoId
      )
      .map(song => {
        return (
          <div
                ...
                >
                  <div className="progress" style={{ height: '0.5rem' }}>
                    <div
                      ...
                      role="progressbar"
                      style={this.getProgress(seek, song.lengthSeconds)}
                      aria-valuenow="100"
                      aria-valuemin="0"
                      aria-valuemax="100"
                    />
